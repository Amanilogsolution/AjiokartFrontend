...
const OrderInTransit = () => {
    ...
    const getOrders = () => {
        ...
        axios.get(`${SITEAPIURL}/orders?type=intransit&perPage=${perPage}&page=${page || 1}`)
            .then(res => {
    ...
    return (
        <React.Fragment>
            ...
            <h1 className="sticky-head">Orders In Transit/Ready to Pickup</h1>
                                ...
                                <table className="table table-bordered  table-striped">
                                    ...
                                    <tbody>
                                        {orders.map(order => <tr key={order.invoice_no}>
                                            ...
                                            <td> <img src={`${IMG_LOCATION}/productImages/ThumbNail-${order.images[0]}`} alt={order.productTitle} className="img-fluid" />
                                            </td>
                                            <td>
